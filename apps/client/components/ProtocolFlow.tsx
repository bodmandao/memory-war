...
export function ProtocolFlow() {
  ...
  return (
    <div className="rounded-xl border border-line bg-surface p-6 sm:p-7">
      {/* Vertical chain at every width. Eight stages with labels as long as
          "0G TEE Attestation" don't fit a single non-wrapping horizontal
          row without either scrolling (which hid stages off-screen with no
          visible cue — see git history) or shrinking past legibility. A
          vertical chain has no such ceiling: every stage is always fully
          visible via ordinary page scroll. */}
